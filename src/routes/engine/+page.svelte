...
<div class="space-y-5 py-0 md:py-5 lg:py-10 xl:py-15">
	...
	<div class="py-5">
		<a href="https://github.com/nightbirdlabs/Nightbird" class="cursor-pointer rounded-lg px-4 py-3 text-lg text-white bg-pink-700 hover:bg-pink-600 transition-colors">
